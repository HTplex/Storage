...
public class FuzzyBlockOfRules {
	...
	Vector<FuzzyRule> allRules = null;
	...
	public String evaluateBlockText() throws EvaluationException{
		...
		for (Enumeration<FuzzyRule> en = allRules.elements() ; en.hasMoreElements() ;){
	...
	public FuzzyBlockOfRules(String rules){
		...
		Vector<String> ruleStrings = new Vector<String>();
